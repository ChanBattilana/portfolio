...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Wo(e,t,n){let r=new Float32Array(Ao),i=new G(0,1,0);return new Ca({name:`SphericalGaussianBlur`,defines:{n:Ao,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:qo(),fragmentShader:`
...
`)}var yc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function bc(e,t){let n=yc[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var xc=new G;function Sc(){return hn.getLuminanceCoefficients(xc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${xc.x.toFixed(4)}, ${xc.y.toFixed(4)}, ${xc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`);try{t=new Worker(URL.createObjectURL(new Blob([n])))}catch(e){return typeof console<`u`&&typeof console.warn==`function`&&console.warn(`🎊 Could not load worker`,e),null}o(t)}return t}})(),p={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:[`square`,`circle`],zIndex:100,colors:[`#26ccff`,`#a25afd`,`#ff5e7e`,`#88ff5a`,`#fcff42`,`#ffa62d`,`#ff36ff`],disableForReducedMotion:!1,scalar:1};function m(e,t){return t?t(e):e}function h(e){return e!=null}function g(e,t,n){return m(e&&h(e[t])?e[t]:p[t],n)}function _(e){return e<0?0:Math.floor(e)}function v(e,t){return Math.floor(Math.random()*(t-e))+e}function y(e){return parseInt(e,16)}function b(e){return e.map(x)}function x(e){var t=String(e).replace(/[^0-9a-f]/gi,``);return t.length<6&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),{r:y(t.substring(0,2)),g:y(t.substring(2,4)),b:y(t.substring(4,6))}}function S(e){var t=g(e,`origin`,Object);return t.x=g(t,`x`,Number),t.y=g(t,`y`,Number),t}function C(e){e.width=document.documentElement.clientWidth,e.height=document.documentElement.clientHeight}function w(e){var t=e.getBoundingClientRect();e.width=t.width,e.height=t.height}function T(e){var t=document.createElement(`canvas`);return t.style.position=`fixed`,t.style.top=`0px`,t.style.left=`0px`,t.style.pointerEvents=`none`,t.style.zIndex=e,t}function E(e,t,n,r,i,a,o,s,c){e.save(),e.translate(t,n),e.rotate(a),e.scale(r,i),e.arc(0,0,1,o,s,c),e.restore()}function D(e){var t=e.angle*(Math.PI/180),n=e.spread*(Math.PI/180);return{x:e.x,y:e.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:e.startVelocity*.5+Math.random()*e.startVelocity,angle2D:-t+(.5*n-Math.random()*n),tiltAngle:(Math.random()*.5+.25)*Math.PI,color:e.color,shape:e.shape,tick:0,totalTicks:e.ticks,decay:e.decay,drift:e.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:e.gravity*3,ovalScalar:.6,scalar:e.scalar,flat:e.flat}}function O(e,t){t.x+=Math.cos(t.angle2D)*t.velocity+t.drift,t.y+=Math.sin(t.angle2D)*t.velocity+t.gravity,t.velocity*=t.decay,t.flat?(t.wobble=0,t.wobbleX=t.x+10*t.scalar,t.wobbleY=t.y+10*t.scalar,t.tiltSin=0,t.tiltCos=0,t.random=1):(t.wobble+=t.wobbleSpeed,t.wobbleX=t.x+10*t.scalar*Math.cos(t.wobble),t.wobbleY=t.y+10*t.scalar*Math.sin(t.wobble),t.tiltAngle+=.1,t.tiltSin=Math.sin(t.tiltAngle),t.tiltCos=Math.cos(t.tiltAngle),t.random=Math.random()+2);var n=t.tick++/t.totalTicks,r=t.x+t.random*t.tiltCos,i=t.y+t.random*t.tiltSin,a=t.wobbleX+t.random*t.tiltCos,s=t.wobbleY+t.random*t.tiltSin;if(e.fillStyle=`rgba(`+t.color.r+`, `+t.color.g+`, `+t.color.b+`, `+(1-n)+`)`,e.beginPath(),o&&t.shape.type===`path`&&typeof t.shape.path==`string`&&Array.isArray(t.shape.matrix))e.fill(M(t.shape.path,t.shape.matrix,t.x,t.y,Math.abs(a-r)*.1,Math.abs(s-i)*.1,Math.PI/10*t.wobble));else if(t.shape.type===`bitmap`){var c=Math.PI/10*t.wobble,l=Math.abs(a-r)*.1,d=Math.abs(s-i)*.1,f=t.shape.bitmap.width*t.scalar,p=t.shape.bitmap.height*t.scalar,m=new DOMMatrix([Math.cos(c)*l,Math.sin(c)*l,-Math.sin(c)*d,Math.cos(c)*d,t.x,t.y]);m.multiplySelf(new DOMMatrix(t.shape.matrix));var h=e.createPattern(u.transform(t.shape.bitmap),`no-repeat`);h.setTransform(m),e.globalAlpha=1-n,e.fillStyle=h,e.fillRect(t.x-f/2,t.y-p/2,f,p),e.globalAlpha=1}else if(t.shape===`circle`)e.ellipse?e.ellipse(t.x,t.y,Math.abs(a-r)*t.ovalScalar,Math.abs(s-i)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI):E(e,t.x,t.y,Math.abs(a-r)*t.ovalScalar,Math.abs(s-i)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI);else if(t.shape===`star`)for(var g=Math.PI/2*3,_=4*t.scalar,v=8*t.scalar,y=t.x,b=t.y,x=5,S=Math.PI/x;x--;)y=t.x+Math.cos(g)*v,b=t.y+Math.sin(g)*v,e.lineTo(y,b),g+=S,y=t.x+Math.cos(g)*_,b=t.y+Math.sin(g)*_,e.lineTo(y,b),g+=S;else e.moveTo(Math.floor(t.x),Math.floor(t.y)),e.lineTo(Math.floor(t.wobbleX),Math.floor(i)),e.lineTo(Math.floor(a),Math.floor(s)),e.lineTo(Math.floor(r),Math.floor(t.wobbleY));return e.closePath(),e.fill(),t.tick<t.totalTicks}function k(e,t,n,a,o){var s=t.slice(),c=e.getContext(`2d`),f,p,m=l(function(t){function l(){f=p=null,c.clearRect(0,0,a.width,a.height),u.clear(),o(),t()}function m(){r&&(a.width!==i.width||a.height!==i.height)&&(a.width=e.width=i.width,a.height=e.height=i.height),!a.width&&!a.height&&(n(e),a.width=e.width,a.height=e.height),c.clearRect(0,0,a.width,a.height),s=s.filter(function(e){return O(c,e)}),s.length?f=d.frame(m):l()}f=d.frame(m),p=l});return{addFettis:function(e){return s=s.concat(e),m},canvas:e,promise:m,reset:function(){f&&d.cancel(f),p&&p()}}}function A(e,n){var r=!e,i=!!g(n||{},`resize`),o=!1,s=g(n,`disableForReducedMotion`,Boolean),c=a&&g(n||{},`useWorker`)?f():null,u=r?C:w,d=e&&c?!!e.__confetti_initialized:!1,p=typeof matchMedia==`function`&&matchMedia(`(prefers-reduced-motion)`).matches,m;function h(t,n,r){for(var i=g(t,`particleCount`,_),a=g(t,`angle`,Number),o=g(t,`spread`,Number),s=g(t,`startVelocity`,Number),c=g(t,`decay`,Number),l=g(t,`gravity`,Number),d=g(t,`drift`,Number),f=g(t,`colors`,b),p=g(t,`ticks`,Number),h=g(t,`shapes`),y=g(t,`scalar`),x=!!g(t,`flat`),C=S(t),w=i,T=[],E=e.width*C.x,O=e.height*C.y;w--;)T.push(D({x:E,y:O,angle:a,spread:o,startVelocity:s,color:f[w%f.length],shape:h[v(0,h.length)],ticks:p,decay:c,gravity:l,drift:d,scalar:y,flat:x}));return m?m.addFettis(T):(m=k(e,T,u,n,r),m.promise)}function y(n){var a=s||g(n,`disableForReducedMotion`,Boolean),f=g(n,`zIndex`,Number);if(a&&p)return l(function(e){e()});r&&m?e=m.canvas:r&&!e&&(e=T(f),document.body.appendChild(e)),i&&!d&&u(e);var _={width:e.width,height:e.height};c&&!d&&c.init(e),d=!0,c&&(e.__confetti_initialized=!0);function v(){if(c){var t={getBoundingClientRect:function(){if(!r)return e.getBoundingClientRect()}};u(t),c.postMessage({resize:{width:t.width,height:t.height}});return}_.width=_.height=null}function y(){m=null,i&&(o=!1,t.removeEventListener(`resize`,v)),r&&e&&(document.body.contains(e)&&document.body.removeChild(e),e=null,d=!1)}return i&&!o&&(o=!0,t.addEventListener(`resize`,v,!1)),c?c.fire(n,_,y):h(n,_,y)}return y.reset=function(){c&&c.reset(),m&&m.reset()},y}var j;function ee(){return j||=A(null,{useWorker:!0,resize:!0}),j}function M(e,t,n,r,i,a,o){var s=new Path2D(e),c=new Path2D;c.addPath(s,new DOMMatrix(t));var l=new Path2D;return l.addPath(c,new DOMMatrix([Math.cos(o)*i,Math.sin(o)*i,-Math.sin(o)*a,Math.cos(o)*a,n,r])),l}function te(e){if(!o)throw Error(`path confetti are not supported in this browser`);var t,n;typeof e==`string`?t=e:(t=e.path,n=e.matrix);var r=new Path2D(t),i=document.createElement(`canvas`).getContext(`2d`);if(!n){for(var a=1e3,s=a,c=a,l=0,u=0,d,f,p=0;p<a;p+=2)for(var m=0;m<a;m+=2)i.isPointInPath(r,p,m,`nonzero`)&&(s=Math.min(s,p),c=Math.min(c,m),l=Math.max(l,p),u=Math.max(u,m));d=l-s,f=u-c;var h=10,g=Math.min(h/d,h/f);n=[g,0,0,g,-Math.round(d/2+s)*g,-Math.round(f/2+c)*g]}return{type:`path`,path:t,matrix:n}}function ne(e){var t,n=1,r=`#000000`,i=`"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif`;typeof e==`string`?t=e:(t=e.text,n=`scalar`in e?e.scalar:n,i=`fontFamily`in e?e.fontFamily:i,r=`color`in e?e.color:r);var a=10*n,o=``+a+`px `+i,s=new OffscreenCanvas(a,a),c=s.getContext(`2d`);c.font=o;var l=c.measureText(t),u=Math.ceil(l.actualBoundingBoxRight+l.actualBoundingBoxLeft),d=Math.ceil(l.actualBoundingBoxAscent+l.actualBoundingBoxDescent),f=2,p=l.actualBoundingBoxLeft+f,m=l.actualBoundingBoxAscent+f;u+=f+f,d+=f+f,s=new OffscreenCanvas(u,d),c=s.getContext(`2d`),c.font=o,c.fillStyle=r,c.fillText(t,p,m);var h=1/n;return{type:`bitmap`,bitmap:s.transferToImageBitmap(),matrix:[h,0,0,h,-u*h/2,-d*h/2]}}n.exports=function(){return ee().apply(this,arguments)},n.exports.reset=function(){ee().reset()},n.exports.create=A,n.exports.shapeFromPath=te,n.exports.shapeFromText=ne})((function(){return typeof window<`u`?window:typeof self<`u`?self:this||{}})(),Q,!1);var Il=Q.exports;Q.exports.create;var Ll=({size:e=20,color:t=`#ffffff`})=>(0,b.jsxs)(`svg`,{width:e,height:e,viewBox:`0 0 24 24`,fill:`none`,stroke:t,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,b.jsx)(`path`,{d:`M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z`}),(0,b.jsx)(`rect`,{x:`2`,y:`9`,width:`4`,height:`12`}),(0,b.jsx)(`circle`,{cx:`4`,cy:`4`,r:`2`})]}),Rl=()=>{let[e,t]=(0,_.useState)(!1),[n,r]=(0,_.useState)(!1),[i,a]=(0,_.useState)({name:``,email:``,message:``}),o=`channbattilana.13@gmail.com`;return(0,b.jsxs)(`section`,{id:`contacto`,className:`contact-section-container`,style:{padding:`5rem 0`,position:`relative`,zIndex:10,borderTop:`1px solid rgba(255, 255, 255, 0.08)`},children:[(0,b.jsxs)(`div`,{className:`container-12col`,children:[(0,b.jsxs)(`div`,{style:{marginBottom:`3rem`},children:[(0,b.jsxs)(`div`,{className:`mono-label`,style:{marginBottom:`0.75rem`},children:[(0,b.jsx)(`span`,{style:{color:`#ffffff`},children:`●`}),` CONTACTO`]}),(0,b.jsx)(`h2`,{style:{fontFamily:`Urbanist, Outfit, sans-serif`,fontWeight:800,fontSize:`clamp(1.8rem, 4.2vw, 3.5rem)`,color:`#ffffff`,letterSpacing:`-0.02em`,margin:0},children:`Iniciemos una conversación`}),(0,b.jsx)(`p`,{style:{color:`#d4d4d8`,fontSize:`1rem`,marginTop:`0.75rem`,maxWidth:`600px`},children:`¿Tienes una idea, consulta o proyecto en mente? Escríbeme directamente por cualquier medio.`})]}),(0,b.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(12, 1fr)`,gap:`2.5rem`,alignItems:`start`},children:[(0,b.jsx)(`div`,{style:{gridColumn:`span 6`},className:`col-mobile-12`,children:(0,b.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`1.25rem`},children:[(0,b.jsxs)(`div`,{className:`glass-card contact-item-card`,style:{padding:`1.5rem 1.75rem`,display:`flex`,alignItems:`center`,justifyContent:`space-between`,gap:`12px`,flexWrap:`wrap`},children:[(0,b.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`14px`,minWidth:0,flex:1},children:[(0,b.jsx)(`div`,{style:{width:44,height:44,borderRadius:12,background:`rgba(255, 255, 255, 0.08)`,border:`1px solid rgba(255, 255, 255, 0.2)`,display:`flex`,alignItems:`center`,justifyContent:`center`,flexShrink:0},children:(0,b.jsx)(se,{size:20,color:`#ffffff`})}),(0,b.jsxs)(`div`,{style:{minWidth:0},children:[(0,b.jsx)(`div`,{style:{fontFamily:`DM Sans, sans-serif`,fontSize:`0.72rem`,color:`#a1a1aa`,letterSpacing:`0.5px`},children:`EMAIL DIRECTO`}),(0,b.jsx)(`a`,{href:`mailto:${o}`,className:`text-break`,style:{fontFamily:`DM Sans, sans-serif`,fontSize:`0.9rem`,fontWeight:700,color:`#ffffff`,textDecoration:`none`,display:`block`},children:o})]})]}),(0,b.jsxs)(`button`,{onClick:()=>{navigator.clipboard.writeText(o),t(!0),Il({particleCount:45,spread:60,origin:{y:.8},colors:[`#ffffff`,`#f4f4f5`,`#a1a1aa`,`#27272a`]}),setTimeout(()=>t(!1),2500)},style:{background:e?`#ffffff`:`rgba(255, 255, 255, 0.08)`,border:e?`1px solid #ffffff`:`1px solid rgba(255, 255, 255, 0.2)`,color:e?`#000000`:`#ffffff`,padding:`8px 16px`,borderRadius:`100px`,cursor:`pointer`,display:`flex`,alignItems:`center`,gap:`6px`,fontFamily:`DM Sans, sans-serif`,fontSize:`0.78rem`,fontWeight:700,transition:`all 0.2s ease`,flexShrink:0,boxShadow:e?`0 0 20px rgba(255,255,255,0.4)`:`none`},children:[e?(0,b.jsx)(N,{size:14}):(0,b.jsx)(ie,{size:14}),(0,b.jsx)(`span`,{children:e?`COPIADO`:`COPIAR`})]})]}),(0,b.jsxs)(`a`,{href:`https://www.linkedin.com/in/santos-battilana-6a4393234/`,target:`_blank`,rel:`noreferrer`,className:`glass-card contact-item-card`,style:{padding:`1.5rem 1.75rem`,display:`flex`,alignItems:`center`,justifyContent:`space-between`,gap:`12px`,textDecoration:`none`},children:[(0,b.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`14px`,minWidth:0},children:[(0,b.jsx)(`div`,{style:{width:44,height:44,borderRadius:12,background:`rgba(255, 255, 255, 0.08)`,border:`1px solid rgba(255, 255, 255, 0.2)`,display:`flex`,alignItems:`center`,justifyContent:`center`,flexShrink:0},children:(0,b.jsx)(Ll,{size:20,color:`#ffffff`})}),(0,b.jsxs)(`div`,{style:{minWidth:0},children:[(0,b.jsx)(`div`,{style:{fontFamily:`DM Sans, sans-serif`,fontSize:`0.72rem`,color:`#a1a1aa`,letterSpacing:`0.5px`},children:`PERFIL PROFESIONAL`}),(0,b.jsx)(`div`,{className:`text-break`,style:{fontFamily:`DM Sans, sans-serif`,fontSize:`0.9rem`,fontWeight:700,color:`#ffffff`},children:`linkedin.com/in/santos-battilana-6a4393234`})]})]}),(0,b.jsx)(`div`,{style:{width:36,height:36,borderRadius:`50%`,background:`rgba(255,255,255,0.06)`,border:`1px solid rgba(255, 255, 255, 0.15)`,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`#ffffff`,flexShrink:0,transition:`all 0.2s ease`},children:(0,b.jsx)(M,{size:18})})]}),(0,b.jsxs)(`a`,{href:`https://wa.me/5491136249686?text=Hola%20Santos,%20vi%20tu%20portfolio...`,target:`_blank`,rel:`noreferrer`,className:`glass-card contact-item-card`,style:{padding:`1.5rem 1.75rem`,display:`flex`,alignItems:`center`,justifyContent:`space-between`,gap:`12px`,textDecoration:`none`},children:[(0,b.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`14px`,minWidth:0},children:[(0,b.jsx)(`div`,{style:{width:44,height:44,borderRadius:12,background:`rgba(255, 255, 255, 0.08)`,border:`1px solid rgba(255, 255, 255, 0.2)`,display:`flex`,alignItems:`center`,justifyContent:`center`,flexShrink:0},children:(0,b.jsx)(le,{size:20,color:`#ffffff`})}),(0,b.jsxs)(`div`,{style:{minWidth:0},children:[(0,b.jsx)(`div`,{style:{fontFamily:`DM Sans, sans-serif`,fontSize:`0.72rem`,color:`#a1a1aa`,letterSpacing:`0.5px`},children:`WHATSAPP DIRECTO`}),(0,b.jsx)(`div`,{style:{fontFamily:`DM Sans, sans-serif`,fontSize:`0.9rem`,fontWeight:700,color:`#ffffff`},children:`+54 9 11 3624-9686`})]})]}),(0,b.jsx)(`div`,{style:{width:36,height:36,borderRadius:`50%`,background:`rgba(255,255,255,0.06)`,border:`1px solid rgba(255, 255, 255, 0.15)`,display:`flex`,alignItems:`center`,justifyContent:`center`,color:`#ffffff`,flexShrink:0,transition:`all 0.2s ease`},children:(0,b.jsx)(M,{size:18})})]})]})}),(0,b.jsx)(`div`,{style:{gridColumn:`span 6`},className:`col-mobile-12`,children:(0,b.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),!(!i.name||!i.email)&&(r(!0),Il({particleCount:75,spread:80,origin:{y:.7},colors:[`#ffffff`,`#f4f4f5`,`#a1a1aa`,`#27272a`]}),setTimeout(()=>{r(!1),a({name:``,email:``,message:``})},4e3))},className:`glass-card contact-form-card`,style:{padding:`2rem`,display:`flex`,flexDirection:`column`,gap:`1.25rem`,border:`1px solid rgba(255, 255, 255, 0.15)`},children:[(0,b.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,marginBottom:`0.5rem`},children:[(0,b.jsx)(fe,{size:18,color:`#ffffff`}),(0,b.jsx)(`h3`,{style:{fontFamily:`Plus Jakarta Sans, sans-serif`,color:`#ffffff`,fontSize:`1.2rem`,margin:0,fontWeight:700},children:`Enviar mensaje directo`})]}),n?(0,b.jsxs)(`div`,{style:{padding:`2rem`,textAlign:`center`,background:`rgba(255, 255, 255, 0.08)`,border:`1px solid #ffffff`,borderRadius:`12px`,color:`#ffffff`,fontFamily:`DM Sans, sans-serif`,boxShadow:`0 0 30px rgba(255,255,255,0.2)`},children:[(0,b.jsx)(N,{size:32,style:{marginBottom:`8px`}}),(0,b.jsx)(`div`,{style:{fontWeight:700},children:`¡MENSAJE ENVIADO CON ÉXITO!`}),(0,b.jsx)(`div`,{style:{fontSize:`0.78rem`,color:`#a1a1aa`,marginTop:`6px`},children:`Te responderé a la brevedad.`})]}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsxs)(`div`,{children:[(0,b.jsx)(`label`,{style:{display:`block`,fontFamily:`DM Sans, sans-serif`,fontSize:`0.75rem`,color:`#a1a1aa`,marginBottom:`6px`,fontWeight:600},children:`NOMBRE / EMPRESA`}),(0,b.jsx)(`input`,{type:`text`,required:!0,placeholder:`Tu nombre o empresa`,value:i.name,onChange:e=>a({...i,name:e.target.value}),style:{width:`100%`,padding:`12px 16px`,background:`#09090b`,border:`1px solid rgba(255, 255, 255, 0.18)`,borderRadius:`8px`,color:`#ffffff`,fontFamily:`Inter, sans-serif`,fontSize:`0.95rem`,outline:`none`}})]}),(0,b.jsxs)(`div`,{children:[(0,b.jsx)(`label`,{style:{display:`block`,fontFamily:`DM Sans, sans-serif`,fontSize:`0.75rem`,color:`#a1a1aa`,marginBottom:`6px`,fontWeight:600},children:`EMAIL DE CONTACTO`}),(0,b.jsx)(`input`,{type:`email`,required:!0,placeholder:`tu@email.com`,value:i.email,onChange:e=>a({...i,email:e.target.value}),style:{width:`100%`,padding:`12px 16px`,background:`#09090b`,border:`1px solid rgba(255, 255, 255, 0.18)`,borderRadius:`8px`,color:`#ffffff`,fontFamily:`Inter, sans-serif`,fontSize:`0.95rem`,outline:`none`}})]}),(0,b.jsxs)(`div`,{children:[(0,b.jsx)(`label`,{style:{display:`block`,fontFamily:`DM Sans, sans-serif`,fontSize:`0.75rem`,color:`#a1a1aa`,marginBottom:`6px`,fontWeight:600},children:`MENSAJE`}),(0,b.jsx)(`textarea`,{rows:3,required:!0,placeholder:`Detalles sobre tu proyecto o consulta...`,value:i.message,onChange:e=>a({...i,message:e.target.value}),style:{width:`100%`,padding:`12px 16px`,background:`#09090b`,border:`1px solid rgba(255, 255, 255, 0.18)`,borderRadius:`8px`,color:`#ffffff`,fontFamily:`Inter, sans-serif`,fontSize:`0.95rem`,outline:`none`,resize:`none`}})]}),(0,b.jsxs)(`button`,{type:`submit`,className:`btn-primary`,style:{marginTop:`0.5rem`,width:`100%`,justifyContent:`center`},children:[(0,b.jsx)(`span`,{children:`Enviar mensaje`}),(0,b.jsx)(ue,{size:16})]})]})]})})]})]}),(0,b.jsx)(`style`,{children:`
      ...
      `})]}),Bl=class extends _.Component{state={hasError:!1};static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,t){console.error(`Uncaught error:`,e,t)}render(){return this.state.hasError?(0,b.jsxs)(`div`,{style:{minHeight:`100vh`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,padding:`2rem`,backgroundColor:`#000000`,color:`#ffffff`,fontFamily:`system-ui, sans-serif`,textAlign:`center`},children:[(0,b.jsx)(`h1`,{style:{fontSize:`2rem`,marginBottom:`1rem`,fontWeight:700},children:`SANTOS BATTILANA`}),(0,b.jsx)(`p`,{style:{color:`#a1a1aa`,maxWidth:`480px`,marginBottom:`1.5rem`,lineHeight:1.6},children:`Hubo un inconveniente al cargar algunos elementos gráficos en este navegador.`}),(0,b.jsx)(`button`,{onClick:()=>window.location.reload(),style:{background:`#ffffff`,color:`#000000`,border:`none`,padding:`12px 24px`,borderRadius:`100px`,fontWeight:700,cursor:`pointer`},children:`Recargar página`})]}):this.props.children}},Vl=()=>{let e=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let t=e.current;if(!t)return;let n=t.getContext(`2d`,{alpha:!0});if(!n)return;let r=t.width=window.innerWidth,i=t.height=window.innerHeight,a=document.createElement(`canvas`),o=document.createElement(`canvas`),s=()=>{if(!a||!o)return;a.width=r,a.height=i,o.width=r,o.height=i;let e=a.getContext(`2d`),t=o.getContext(`2d`);if(!e||!t)return;e.clearRect(0,0,r,i),t.clearRect(0,0,r,i);let n=Math.min(Math.floor(r*i/1e4),160);for(let a=0;a<n;a++){let n=Math.random()*r,o=Math.random()*i,s=Math.random()*1.3+.4,c=a%2==0?t:e;c.beginPath(),c.arc(n,o,s,0,Math.PI*2),c.fillStyle=`#ffffff`,c.globalAlpha=Math.random()*.5+.3,c.fill(),s>1.2&&(c.beginPath(),c.arc(n,o,s*2.2,0,Math.PI*2),c.fillStyle=`rgba(255, 255, 255, 0.12)`,c.fill())}};s();let c={x:0,y:0,length:0,speed:0,dx:0,dy:0,opacity:0,active:!1},l=Date.now()+5e3,u=()=>{let e=Math.PI/4+(Math.random()*.16-.08),t=Math.random()*6+7;c={x:r*.7*Math.random(),y:i*.35*Math.random(),length:Math.random()*70+60,speed:t,dx:Math.cos(e)*t,dy:Math.sin(e)*t,opacity:.85,active:!0},l=Date.now()+Math.random()*9e3+6e3},d,f=!0,p=()=>{if(!f)return;if(n.clearRect(0,0,r,i),a&&(n.globalAlpha=.85,n.drawImage(a,0,0)),o){let e=Date.now()*.0018;n.globalAlpha=.4+Math.sin(e)*.35,n.drawImage(o,0,0)}let e=Date.now();if(!c.active&&e>l&&u(),c.active){if(c.x+=c.dx,c.y+=c.dy,c.opacity-=.015,c.opacity<=0||c.x>r||c.y>i)c.active=!1;else{n.save(),n.beginPath();let e=n.createLinearGradient(c.x,c.y,c.x-c.dx*5,c.y-c.dy*5);e.addColorStop(0,`rgba(255, 255, 255, ${c.opacity})`),e.addColorStop(1,`rgba(255, 255, 255, 0)`),n.strokeStyle=e,n.lineWidth=1.5,n.moveTo(c.x,c.y),n.lineTo(c.x-c.dx*5,c.y-c.dy*5),n.stroke(),n.restore()}}n.globalAlpha=1,d=requestAnimationFrame(p)};d=requestAnimationFrame(p);let m,h=()=>{clearTimeout(m),m=window.setTimeout(()=>{r=t.width=window.innerWidth,i=t.height=window.innerHeight,s()},150)},g=()=>{f=!document.hidden,f?d=requestAnimationFrame(p):cancelAnimationFrame(d)};return window.addEventListener(`resize`,h),document.addEventListener(`visibilitychange`,g),()=>{cancelAnimationFrame(d),window.removeEventListener(`resize`,h),document.removeEventListener(`visibilitychange`,g),a=null,o=null}},[]),(0,b.jsx)(`canvas`,{ref:e,style:{position:`fixed`,top:0,left:0,width:`100vw`,height:`100vh`,pointerEvents:`none`,zIndex:1,transform:`translateZ(0)`,willChange:`transform`}})};function Hl(){return(0,b.jsxs)(Bl,{children:[(0,b.jsx)(Vl,{}),(0,b.jsx)(`div`,{className:`vignette-overlay`}),(0,b.jsx)(x,{children:(0,b.jsxs)(`div`,{style:{position:`relative`,zIndex:10,width:`100%`},children:[(0,b.jsx)(ge,{}),(0,b.jsxs)(`main`,{children:[(0,b.jsx)(Pl,{}),(0,b.jsx)(Fl,{}),(0,b.jsx)(Z,{}),(0,b.jsx)(Rl,{})]}),(0,b.jsx)(zl,{})]})})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,b.jsx)(_.StrictMode,{children:(0,b.jsx)(Hl,{})}));